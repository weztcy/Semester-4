...
public class Form_Distributor extends javax.swing.JDialog {

    inventori_barang.Connection_DB konek = new inventori_barang.Connection_DB();

    public Form_Distributor(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void GetData() {
        try {
            ...
            String[] columnNames = {"ID Distributor", "Kode Distributor", "Nama Distributor", "Nomor Telepon", "Alamat"};
            ...
            Logger.getLogger(Form_Distributor.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        txttemp_kode.setFont(new java.awt.Font("Lucida Grande", 0, 18)); // NOI18N
        ...
        datatable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID Distributor", "Kode Distributor", "Nama Distributor", "Nomor Telepon", "Alamat"
            }
        ));
        ...
        lbl_action.setText("Form Tambah Data Distributor");
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            Form_Distributor dialog = new Form_Distributor(new javax.swing.JFrame(), true);
