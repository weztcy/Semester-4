...
public class Form_BarangMasuk extends javax.swing.JDialog {

    inventori_barang.Connection_DB konek = new inventori_barang.Connection_DB();

    public Form_BarangMasuk(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        GetData();
        BtnEnabled(false);
        btnsave.setText("Masukkan Barang");
    }
    ...
    private void initComponents() {
        ...
        cmbid_kategori.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cmbid_kategoriActionPerformed(evt);
            }
        });
        ...
        lbl_action.setText("Form Transaksi Barang Masuk");
        ...
        jLabel8.setText("Data Transaksi Barang Masuk");
    ...
    private void cmbid_kategoriActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbid_kategoriActionPerformed

    }//GEN-LAST:event_cmbid_kategoriActionPerformed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            Form_BarangMasuk dialog = new Form_BarangMasuk(new javax.swing.JFrame(), true);
