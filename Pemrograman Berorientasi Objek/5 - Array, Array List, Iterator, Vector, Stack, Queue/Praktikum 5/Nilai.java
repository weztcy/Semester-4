...
public class Nilai {
    ...
    void judul(){
        System.out.println("NIM\tNamat\tNIlai Tugas\tNIlai UTS\tNIlai UAS\tNilai Akhir\tIndex\tPredikat");
    }
    void daftarNilai(){
        System.out.println(nim + "\t" + nama + "\t" + nilaiTugas + "\t\t" + nilaiUTS + "\t\t" + nilaiUAS + "\t\t" + nilaiAkhir + "\t\t" + indexNilai + "\t" + predikat);
    }
}